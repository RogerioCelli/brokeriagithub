...
app.get('/api/dashboard/stats', authenticateToken, async (req, res) => {
    try {
      ...
      SELECT 
        ...
        COUNT(DISTINCT telefone_whatsapp) as clientes_unicos,
...
app.get('/api/registros/recentes', authenticateToken, async (req, res) => {
    try {
      ...
      SELECT 
        ...
        qtde_mensagens,
        etapa_funil,
        data_criacao_registro AT TIME ZONE 'UTC' AT TIME ZONE 'America/Sao_Paulo' as data_contato,
